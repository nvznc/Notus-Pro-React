      ...
      <div className="home-hero">
        ...
        <div className="home-container01">
          <div className="home-container02">
            <h1 className="home-text">Transformamos tus idea en Software</h1>
            <span className="home-text01">
              <span></span>
              <span>
                Nuestro equipo de programadores e ingenieros cuenta con mas de
                15 años de experiencia en el area de programación, ofreciendo
                soluciones nuevas e implementando mejoras en software ya
                existente.
              </span>
            </span>
          </div>
          ...
          <div className="home-container23">
            <Link to="/profile" className="home-navlink">
              <div className="home-container24">
                <MemberDetails image_src="/team1-200h.jpg"></MemberDetails>
